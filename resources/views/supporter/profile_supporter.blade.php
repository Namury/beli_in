        ...
        <div class="main">
            ...
            <div class="card page-user">
                <div class="page-user-header">
                    <h1>Akun Saya</h1>
                    <ul>
                        <li class="active"><a href="">Edit Profil</a></li>
                ...
                <form>
                    ...
                    <div class="form-group">
                        <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukkan Username">
                    </div>
                    <div class="form-group">
