                ...
                <div class="card card-post">
                    <div class="post">
                        ...
                        <div class="profile-info">
                            ...
                            <div class="handle">
                                <a href="/{{ $post->user->page_slug}}/support">@ {{ $post->user->page_slug}}</a>
                            </div>
                            <div class="post-text">
                                <p>{!! $post->content !!}</p>
                            </div>
