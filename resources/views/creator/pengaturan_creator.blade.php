...
<head>
	...
	<link rel="stylesheet" media="screen and (min-width: 800px) " href="{{ asset('style/css/stylesetting.css') }}" >
	<link rel="stylesheet" media="screen and (min-width: 0px)and (max-device-width: 789px) " href="{{ asset('style/css/stylesettingHP.css') }}" >
    ...
    <div class="wrapper">
        ...
        <nav class="sidebar" id="sidebar">
            <ul class="list-unstyled components">
                <li>
                    <a id="sidebara" href="/dashboard"><svg width="" height="" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="active">
                    <a id="sidebara4" href="/setting">
                        <svg width="30" height="" viewBox="0 0 51 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            </svg> <div class="sidebaricon " id="sidebartext4">Pengaturan</div>
                    </a>
                </li>
                <li>
                    <a id="sidebara5" href="/logout">
        ...
        <div class="main">
            ...
            <div class="card page-setting">
                ...
                <form>
                    <h4>Link Halaman Saya</h4>
                    <div class="form-group">
                        <input type="username" class="form-control" id="exampleInputUsername1" aria-describedby="unameHelp" disabled value="beli.in/yourname" />
                    </div>
                </form>
...
<script>
    function openNav() {
      ...
      document.getElementById("sidebarpc").style.width = "150px";
